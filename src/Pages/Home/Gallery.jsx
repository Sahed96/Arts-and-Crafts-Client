...
const Gallery = () => {
    return (
        <section className="py-6 mt-10 dark:text-gray-900">
            <h1 className=" text-4xl font-bold mb-10 ml-40">Upcoming Collection Gallery</h1>
	<div className="container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4">
		...
		<img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square" src="https://i.ibb.co/4WNhZKt/sculpture-4802916-1280.jpg" />
		...
		<img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square" src="https://i.ibb.co/4YvrhfW/art-1699989-1280.jpg" />
		...
		<img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square" src="https://i.ibb.co/ygC2GQZ/sandburg-1639999-1280.jpg" />
		<img alt="" className="w-full h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square" src="https://i.ibb.co/N6SQMgN/sculpture-8587884-1920.jpg" />
